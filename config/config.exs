...
config :midterm, MidtermWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: MidtermWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: Midterm.PubSub,
  live_view: [signing_salt: "MNGfz8/2"]
...
config :midterm, Midterm.Mailer, adapter: Swoosh.Adapters.Local
