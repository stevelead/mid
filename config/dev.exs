...
config :midterm, MidtermWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "mwOUl1A12uDcarpJro6VP2hdeleq7hyjyDhhQ2f3jBKBO++4kCCqFdDvYYCJyp5v",
  watchers: [
...
config :midterm, MidtermWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/midterm_web/(live|views)/.*(ex)$",
      ~r"lib/midterm_web/templates/.*(eex)$"
    ]
  ]
