defmodule Midterm.Repo.Migrations.CreateNotificationPreferences do
  ...
  def change do
    create table(:notification_preferences) do
      ...
      add :account_watched_address_id,
          references(:account_watched_addresses, on_delete: :delete_all)

      timestamps()
    end

    create index(:notification_preferences, [:account_watched_address_id])
  end
end
